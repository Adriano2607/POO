...
leitores.push(new Leitor("Lucas","204.984.930-32","(51) 99441-1880","Rua Carlos Trein Filho"));
leitores.push( new Leitor("Adriano","204.984.930-32","(51) 99441-1880","Rua Carlos Trein Filho"));
    ...
    this.livrosParaVender = livrosParaVender;
        ...
        this.livrosParaVender.push(livroQueQueroVender);
            ...
            console.log("Lista de Livros para Venda");
             ...
             console.log("Titulo: " + lista.titulo + " do Autor: " + lista.autor.nome + ".");
             }
            }
 }
...
let loja = new Loja();
loja.addLivrosParaVenda( new Livro("A Biblioteca da Meia-Noite", autores[0], "Comedia", "2022"));
loja.addLivrosParaVenda(new Livro("Verity ", autores[1], "Guerra", "2022"));
loja.addLivrosParaVenda(new Livro("A paciente silenciosa ", autores[1], "Drama", "2022"));
...
//classe emprestimo
  ...
  dataDevolucao: string;
    constructor(livro: Livro,leitor: Leitor,dataEmprestimo: string,dataDevolucao: string) {
    this.livro = livro;
    this.leitor = leitor;
...
//classe biblioteca
  ...
  livrosEmprestados: Array<Emprestimo>;
    constructor(livrosParaEmprestimo: Array<Livro> = [],livrosEmprestados: Array<Emprestimo> = []) {
        ...
        this.livrosParaEmprestimo.push(livroQueQueroEmprestar);
            ...
            console.log("Lista de Livros para Emprestimo");
             ...
             console.log("Titulo: " + lista.titulo + " do Autor: " + lista.autor.nome + ".");
                ...
                pegarLivroEmprestado(livroParaPegarEmprestado: Livro,leitor: Leitor, dataEmprestimo: string, dataDevolucao: string): void {
                console.log("O Leitor " +leitor.nome +" pegou empresado o livro " +livroParaPegarEmprestado.titulo +" na data: " +dataEmprestimo +" e devolveu em: " +dataDevolucao);
                let emprestimo = new Emprestimo(livroParaPegarEmprestado,leitor,dataEmprestimo,dataDevolucao);
                let indice: number = this.livrosParaEmprestimo.indexOf(livroParaPegarEmprestado);
...
biblioteca.addLivrosParaEmprestimo(new Livro("Mais Esperto que o Diabo", autores[1], "Livro de autoajuda", "2010"));
biblioteca.addLivrosParaEmprestimo(new Livro("Mindset: A Nova Psicologia do Sucesso",autores[0],"Livro de autoajuda","2002"));
biblioteca.addLivrosParaEmprestimo(new Livro("A Arte da Guerra", autores[1], "Livro de autoajuda", "2010"));
biblioteca.listaLivrosParaEmprestimo();
biblioteca.pegarLivroEmprestado(biblioteca.livrosParaEmprestimo[0],leitores[1],"20/08/2022","25/08/2022");
